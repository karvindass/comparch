...
void eval_micro_sequencer() {
    ...
    /************ Lab4 ***********/
    int myIRD1, myCOND2, myMAR0, myIR15, myIR14, myIR12, myPSR15, myC;
    /*****************************/
    ...
    /************ Lab4 ***********/
    myIRD1 = CURRENT_LATCHES.MICROINSTRUCTION[IRD1];
    ...
    myC = ( CURRENT_LATCHES.MAR<12288 ) ? 1 : 0;
    /*****************************/
    ...
    if( myIRD == 1 )
    {
        if (myIRD1==0)
            ...
            NEXT_LATCHES.STATE_NUMBER = 32 + 16 + myIR15*8 + myIR14*4 + myIR12;
    }
    else
    {
        myJ5 = ( myCOND2 && myCOND1 && (!myCOND0) && ( myMAR0 && myIR14 ) ) || myJ5;
        myJ4 = ( myCOND2 && (!myCOND1) && myCOND0 && ( myC && myPSR15 ) ) || myJ4;
...
int GATE_PC_INPUT, GATE_MDR_INPUT, GATE_ALU_INPUT, GATE_MARMUX_INPUT, GATE_SHF_INPUT, GATE_VECTOR_INPUT, GATE_PSR_INPUT;
...
void eval_bus_drivers() {
    ...
    myVECTORMUX = CURRENT_LATCHES.MICROINSTRUCTION[VECTORMUX1]*2 + CURRENT_LATCHES.MICROINSTRUCTION[VECTORMUX0];
